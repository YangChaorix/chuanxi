<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:54:"D:\phpStudy\WWW\chuanxi/app/home\view\cases\index.html";i:1523340395;s:57:"D:\phpStudy\WWW\chuanxi/app/home\view\common\sheader.html";i:1523341273;s:61:"D:\phpStudy\WWW\chuanxi/app/home\view\common\header_menu.html";i:1523423593;s:57:"D:\phpStudy\WWW\chuanxi/app/home\view\common\sfooter.html";i:1523422805;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="sp_logo pjax"> <a href="/"><img src="__HOME__/images/logo-white.png" alt="<?php echo $sys['name']; ?>"></a></div>
	...
	<div class="container">
	  ...
	  <div class="main">
	      <div class="con-com">
	          <div class="content case-cont">
	              <div class="com-word com-zs ">
	                  <div class="zs-title">
					    <notempty name="filter">
							<?php if(is_array($filter) || $filter instanceof \think\Collection || $filter instanceof \think\Paginator): $i = 0; $__LIST__ = $filter;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		                      ...
		                      <strong><?php echo $vo['name']; ?></strong>
		                      	 <?php if(is_array($vo['setup']) || $vo['setup'] instanceof \think\Collection || $vo['setup'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['setup'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo_sub): $mod = ($i % 2 );++$i;?>
		                       	 	 <a id="ms_0" class="<?php if($map[$vo['field']] == $key): ?>active<?php endif; ?>"  value="<?php echo $key; ?>"    type="<?php echo $vo['field']; ?>"  href="<?php echo url('Cases/index',array($vo['field']=>$key)); ?><?php echo $param; ?>"><?php echo $vo_sub; ?>
		                       	 	 </a> 
		                    ...
		                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			                        <li>
			                            <div class="list-hover">
			                              <a href="<?php echo url('cases/detail',array('id'=>$vo['id'])); ?>">
			                                  <img src="__PUBLIC__/<?php echo $vo['thumb']; ?>"  alt="<?php echo $vo['title']; ?>" />
			                              </a>                          
			                              <p class="case-tit" style="<?php echo $vo['title_style']; ?>"><?php echo $vo['title']; ?></p>
			                              <!-- <p>设计师：</p>
			                              <p>套内面积：107.30 平方米</p> -->
			                              
			                              <?php if(is_array($filter) || $filter instanceof \think\Collection || $filter instanceof \think\Paginator): $i = 0; $__LIST__ = $filter;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
			                              	  <p class="case-a1">
			                              	  	<?php echo $vo2['name']; ?>:<?php echo $vo2['setup'][$vo[$vo2['field']]]; ?>
			                              	  </p>
				                          <?php endforeach; endif; else: echo "" ;endif; ?>
			                              <p class="readmore"><a href="<?php echo url('cases/detail',array('id'=>$vo['id'])); ?>" target="_blank">查看详细</a></p>
			                            </div>
			                        </li>
		                        <?php endforeach; endif; else: echo "" ;endif; else: ?>
		                     <div style="color: red;text-align:center;">没有相关数据。。</div>
		                    <?php endif; ?>                    
	                    </ul>
	                  </div>
