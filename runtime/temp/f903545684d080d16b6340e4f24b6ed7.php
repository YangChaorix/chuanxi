<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"/data/home/byu3022500001/htdocs/app/home/view/index/index.html";i:1508051835;s:65:"/data/home/byu3022500001/htdocs/app/home/view/common/sheader.html";i:1505818914;s:69:"/data/home/byu3022500001/htdocs/app/home/view/common/header_menu.html";i:1507797115;s:65:"/data/home/byu3022500001/htdocs/app/home/view/common/sfooter.html";i:1515769637;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="sp_logo pjax"> <a href="/"><img src="__HOME__/images/logo-white.png" alt="传禧互联网家装平台"></a></div>
		<div class="sp_logo pjax">
			<a href="/" title="传禧互联网家装平台"><img src="__HOME__/images/logo-white.png" alt="传禧互联网家装平台"></a>
		</div>
	</div>
				...
				<div class="design design1">
					...
					<div class="design-item">
						<a href="<?php echo $adList11[1]['url']; ?>" title="<?php echo $adList11[1]['name']; ?>">
							<div class="thumb">
								<img class="thumb-img thumb-img1" src="__PUBLIC__/<?php echo $adList11[1]['pic']; ?>" alt="">
							</div>
							<div class="caption trunc">
				...
				<div class="design design2">
					<div class="design-item design-item2">
						<a href="<?php echo $adList11[2]['url']; ?>" title="<?php echo $adList11[2]['name']; ?>">
							<div class="thumb">
								<img class="thumb-img thumb-img2" src="__PUBLIC__/<?php echo $adList11[2]['pic']; ?>" alt="">
							</div>
							<div class="caption trunc">
					...
					<div class="design-item  design-item2">
						<a href="<?php echo $adList11[3]['url']; ?>" title="<?php echo $adList11[3]['name']; ?>">
							<div class="thumb">
								<img  class="thumb-img thumb-img2" src="__PUBLIC__/<?php echo $adList11[3]['pic']; ?>" alt="">
							</div>
							<div class="caption trunc">
		...
		<ul class="article_list store cf">
			<?php if(!(empty($adList12) || (($adList12 instanceof \think\Collection || $adList12 instanceof \think\Paginator ) && $adList12->isEmpty()))): if(is_array($adList12) || $adList12 instanceof \think\Collection || $adList12 instanceof \think\Paginator): $i = 0; $__LIST__ = $adList12;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<li>
					<a href="<?php echo $vo['url']; ?>" target="_blank" title="<?php echo $vo['name']; ?>">
						<div class="thumb">
							<div class="cover" data-cover="__PUBLIC__/<?php echo $vo['pic']; ?>"></div>
							<div class="overlay">
